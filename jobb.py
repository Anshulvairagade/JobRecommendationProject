...
def main():
    ...
    # userprofile_df, job_df = load_data('recommended_jobs.pkl')

    # if userprofile_df is None or job_df is None:
    #     st.warning("Data not loaded successfully. Please check the file.")
    #     return
